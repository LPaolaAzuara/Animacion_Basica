...
Fecha de entrega: 11 de octubre del 2024
*/
#include <iostream>
#include <cmath>
...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Fuentes de luz | Paola Azuara", nullptr, nullptr);
	...
	Model Dog((char*)"Models/Cube1x1.obj");
	Model Piso((char*)"Models/piso.obj");
	//Model Cancha((char*)"Models/cancha.obj");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		//Mandamos los parametros al shader correspondiente
	...
	/*	glm::vec3 lightColor;
		...
		glUniform3f(glGetUniformLocation(lightingShader.Program, "pointLights[1].specular"), 0.0f, 0.0f, 0.8f);
		...
		glUniform3f(glGetUniformLocation(lightingShader.Program, "pointLights[2].specular"), 0.8f, 0.0f, 0.0f);
		...
		glUniform3f(glGetUniformLocation(lightingShader.Program, "pointLights[3].diffuse"), 0.0f, 0.8f, 0.0f);
		glUniform3f(glGetUniformLocation(lightingShader.Program, "pointLights[3].specular"), 0.9f, 0.0f, 0.0f);
		...
		glUniform3f(glGetUniformLocation(lightingShader.Program, "pointLights[4].diffuse"), 0.8f, 0.0f, 0.8f);
		glUniform3f(glGetUniformLocation(lightingShader.Program, "pointLights[4].specular"), 0.0f, 0.0f, 0.9f);
		glUniform1f(glGetUniformLocation(lightingShader.Program, "pointLights[4].constant"), 1.0f);
		glUniform1f(glGetUniformLocation(lightingShader.Program, "pointLights[4].linear"), 0.0f);
		glUniform1f(glGetUniformLocation(lightingShader.Program, "pointLights[4].quadratic"), 0.0f);
...
///////
	if (keys[GLFW_KEY_C])
	{
		pointLightPositions[0].r += 0.01f;
		pointLightPositions[1].r += 0.1f;
		pointLightPositions[2].r += 0.1f;
		pointLightPositions[3].r += 0.1f;
		pointLightPositions[4].r += 0.1f;
	}
	if (keys[GLFW_KEY_V])
	{
		pointLightPositions[0].g += 0.1f;
		pointLightPositions[1].g += 0.1f;
		pointLightPositions[2].g += 0.1f;
		pointLightPositions[3].g += 0.1f;
		pointLightPositions[4].g += 0.1f;

	}
	if (keys[GLFW_KEY_B])
	{
		pointLightPositions[0].b += 0.1f;
		pointLightPositions[1].b += 0.1f;
		pointLightPositions[2].b += 0.1f;
		pointLightPositions[3].b += 0.1f;
		pointLightPositions[4].b += 0.1f;
	}
}
